...
In addition, an honorarium fund is requested to allow us to recognise the evaluation team (and any significant community contributions).
...
| Honorarium fund | 6,000 |
| **Total** | **38,250** |

### Hosting

The hosting cost is anticipated to be around $500 to have multiple CMS systems 
running for evaluation purposes. Ongoing, we assume a $1,000 annual consolidated 
cost for hosting but some or all conferences may prefer to use their funding 
lines to run their own instances of the software.
